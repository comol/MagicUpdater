...
{
	public class LockBackgroundJobsOnServer1C : OperAction
	{
		public LockBackgroundJobsOnServer1C(int? _operationId) : base(_operationId) { }
		protected override void ActExecution()
		{
			...
			for (int i = 0; i < ClustersCount; i++)
			{
				...
				for (int j = 0; j < Count; j++)
				{
					...
					{ 						
						currentIB.ScheduledJobsDenied = true;
